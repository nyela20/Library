...
import '../static/css/AdminBookList.css';
...
export default function AdminBookList() {
  ...
  const handleDelete = async (_id) => {
    ...
    try {
      ...
      // Si l’utilisateur n’a pas les droits, on redirige vers une autre page
    ...
    <div className="admin-page-container">
      <header className="admin-header">
        ...
        <div className="admin-actions">
          <button className="btn-back" onClick={() => navigate('/dashboard-personnel')}>&larr; Tableau de bord</button>
